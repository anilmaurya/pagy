...
describe Pagy::Frontend do
  ...
  describe "#pagy_t" do
    ...
    it 'pluralizes and interpolates' do
      ...
      frontend.pagy_t('pagy.info.multiple_pages', count: 10).must_equal "Displaying items <b>%{from}-%{to}</b> of <b>10</b> in total"
    end
  ...
  describe "Pagy::I18n" do
    ...
    it 'loads custom :locale, :filepath and :pluralize' do
      ...
      Pagy::I18n.t(nil,  'pagy.info.single_page', count: 0).must_equal "Displaying <b>1</b> item"
      Pagy::I18n.t('en', 'pagy.info.single_page', count: 0).must_equal "Displaying <b>1</b> item"
      Pagy::I18n.t('en', 'pagy.info.single_page', count: 1).must_equal "Displaying <b>1</b> item"
      Pagy::I18n.t('en', 'pagy.info.single_page', count: 10).must_equal "Displaying <b>1</b> item"
    ...
    it 'switches :locale according to @pagy_locale' do
      ...
      frontend.pagy_t('pagy.info.no_items', count: 1).must_equal "Geen stuks gevonden"
      frontend.instance_variable_set(:'@pagy_locale', 'en')
      frontend.pagy_t('pagy.info.no_items', count: 1).must_equal "No items found"
      frontend.instance_variable_set(:'@pagy_locale', nil)
      frontend.pagy_t('pagy.info.no_items', count: 1).must_equal "Kein Einträge gefunden"
      frontend.instance_variable_set(:'@pagy_locale', 'unknown')
      frontend.pagy_t('pagy.info.no_items', count: 1).must_equal "Kein Einträge gefunden" # silently serves the first loaded locale
      Pagy::I18n.load(locale: 'en') # reset for other tests
